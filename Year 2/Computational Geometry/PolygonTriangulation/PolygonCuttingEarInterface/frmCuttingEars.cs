...
namespace PolygonCuttingEarInterface
{
	...
	public class frmCuttingEars : System.Windows.Forms.Form
	{
			...
			UnhandledExceptionEventArgs args)
		{
			...
			//write to event log:
			string logSource="Polygon Triangulation";
			string logName="Polygon Triangulation Log";
			if (!EventLog.SourceExists(logSource, logName))
			{
			...
			//show error message:
			string errMsg="This program processes Simple Polygon only. \n";
			errMsg += "Please check the input data.";
			MessageBox.Show(errMsg, "Input Data Error", MessageBoxButtons.OK,
		...
		private void ReadDefaultData()
		{
			...
			m_aPolygon=new Point[6];
			
			m_aPolygon[0]=new Point(50,70);
			m_aPolygon[1]=new Point(180,280);
			m_aPolygon[2]=new Point(140,140);
			
			m_aPolygon[3]=new Point(150,85);
			m_aPolygon[4]=new Point(190,50);
			m_aPolygon[5]=new Point(260,20);
			/*
			m_aPolygon=new Point[5];
			
			m_aPolygon[0]=new Point(50,50);
			m_aPolygon[1]=new Point(50,250);
			m_aPolygon[2]=new Point(160,200);
			
			m_aPolygon[3]=new Point(300,250);
			m_aPolygon[4]=new Point(300,50);
			*/
		}
